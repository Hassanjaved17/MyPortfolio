    ...
    >
      <div>
        ...
        <a
          ...
          className={`text-lg flex gap-2 items-center text-[#f59e0b] hover:text-white transition-all duration-500 cursor-pointer sm:justify-self-center ${align === "left" ? "md:justify-self-end" : "md:justify-self-start"
            }`}
        >
      ...
      <div className="max-h-[220px] max-w-[400px] rounded-xl overflow-hidden hover:scale-110 transform transition-all duration-500 relative border border-white/20">
        {/* Dark overlay on idle, fades out on hover to reveal screenshot */}
