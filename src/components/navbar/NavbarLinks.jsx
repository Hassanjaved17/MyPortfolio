...
const NavbarLinks = () => {
  return (
    <ul
      className="flex lg:flex-row sm:flex-col gap-4 lg:gap-4 xl:gap-6 text-white font-body
                 ...
                 text-center lg:text-sm xl:text-md sm:text-xl
    ...
    >
      {links.map((link, index) => {
        return (
          <li key={index} className="group whitespace-nowrap">
            <Link
              spy={true}
              smooth={true}
              duration={500}
